                        ...
                        <Col md={6} style={{ padding: '0px' }}>
                            <div class="aboutSystemContent">
                                <div className='aboutSystemText'>
                                    <p> System składa się z 2 części: urządzeń oraz aplikacji.
                                ...
                                Aplikacja została przygotowana tak, aby było można z niej korzystać na każdym smartfonie, tablecie czy komputerze.</p>
                                </div>
                            </div>
                        </Col>
                    </Row>
